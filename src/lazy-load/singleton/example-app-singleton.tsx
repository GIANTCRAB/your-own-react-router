...
import {useRouterHookSingleton} from "../../router/singleton/router-hook-singleton.ts";
import RouterRootSingleton from "../../router/singleton/router-root-singleton.tsx";
...
export function ExampleAppSingleton() {
    return <>
        <ExampleAppNavMemoized/>
        <RouterRootSingleton routes={routes}/>
    </>;
}
